            ...
            <div className="hero-content flex-col lg:flex-row-reverse mx-auto mt-32">
                ...
                <div className='mr-10'>
                    ...
                    <p className="py-6 font-poppins">
                        Bazaar Market is an NFT bartering market that allows users to swap multiple NFTs with one another. We also have our own NFT project generated using the Stable Diffusion text-to-image model while the names and personalities were generated by GPT3. Users can sign in through Discord and mint a pack of 6 NFTs for free on polygon mainnet with the code ETHGLOBAL2022 and begin trading with each other.
                    </p>
